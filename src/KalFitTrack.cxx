...
#include "GaudiKernel/NTuple.h"//yzhang add
...
int KalFitTrack::driftdist_choice_ = 0;
int KalFitTrack::debug_ = 4;
...
int KalFitTrack::Tof_correc_fltLenFromRec_ = 0;
...
// chi2 cut set :
int KalFitTrack::nmdc_hit2_ = 5000;//yzhang changed from 500 to 5000 2014-04-09 
...
double KalFitTrack::chi2_next(Helix& H, KalFitHitMdc & HitMdc ){
  ...
  H.pivot(x0kal);
  if(debug_ == 4) std::cout<<__FILE__<<"   "<<__LINE__<<" change pivot to x0kal "<<std::endl;
