...
//	RecMdcKalTrackCol* kalcol,RecMdcKalHelixSegCol* segcol);
    ...
    int muls_, loss_, lr_, activeonly_, tofflag_, tof_hyp_, tofflag_fltLen_;
    ...
    int driftdist_choice_;//yzhang add 2014-05-03 
    ...
    int m_nPivotCnv;//yzhang for pivot conversion
    int m_pivotCnvSelector;//yzhang for pivot conversion
    bool m_fix2TurnTrackInnerWall;//yzhang for innerwall of 2 turn track
    bool m_fixInnerWall;//yzhang innerwall fix flag
    double m_t0;//yzhang 2014-05-30 for chargedgeantino
  ...
  private:
    ...
    int iniTrkPar; // -1: from MC truth; 1: from MDC
    double myMCHelix[5];
    ...
    //set momentum to RecMdcKalTrack yzhang add 2014-04-23 
    void setRecMdcKalTrackMom(RecMdcKalTrack* kalTk,const HepVector helix, int l_mass);
