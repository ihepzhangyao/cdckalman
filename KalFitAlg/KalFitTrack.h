...
public:
	...
	double intersect_cylinder_back(double r) const;//yzhang add 2014-05-02 
	...
	// event start time
	static void  setEventStartTime(double t0);
	double getEventStartTime(void) const;
	...
	static int Tof_correc_fltLenFromRec_;  
	...
	{
		int n=0;
		for(int i=0; i<43; i++) n+=myLayerUsed[i];//yzhang FIXME temp
		return n;
	}
